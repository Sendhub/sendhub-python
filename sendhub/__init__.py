...
class BillingPlans(APIResource):
    ...
    def create_plan(
        ...
        return self.create_object(
            ...
            maxSmsRecipients=max_sms_recipients,
            maxS2sRecipients=max_s2s_recipients,
            shortcodeKeywords=shortcode_keywords,
            maxVoiceMinutes=max_voice_minutes,
            maxConferenceLines=max_conference_lines,
            maxConferenceParticipants=max_conference_participants,
            marketingLines=marketing_lines,
            autoAttendant=auto_attendant,
            maxApiRequests=max_api_requests,
            maxBasicVmTranscriptions=max_basic_vm_transcriptions,
            maxPremiumVmTranscriptions=max_premium_vm_transcriptions,
